...
function Shoes() {
  ...
  return (
    <div className='border  bg-white absolute  left-0 h-[800px] w-full mt-4 p-5 px-[13%]  overflow-y-scroll '>
        <div className='flex mt-7 gap-[10%] '>
            <div className=''>
                <h1 className='text-2xl'>SNEKERS</h1>
                <div className='mt-4'>
                    {Snekers.map((lists)=>(
            ...
            <div className=''>
            <h1 className='text-2xl'>SLIP ONS</h1>
            <div className='mt-4'>
                    {Slipons.map((lists)=>(
                        <p id='index' className='text-sm leading-10'>{lists}</p>
                    ))}
            ...
            <div className=''>
            <h1 className='text-2xl'>ATHLEISURE</h1>
            <div className='mt-4'>
